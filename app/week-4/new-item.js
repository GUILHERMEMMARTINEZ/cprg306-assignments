...
export default function NewItem() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-gray-800 p-10 rounded-lg shadow-md w-96">
      <div className="mb-6">
        ...
        <input
          ...
          required
          className="mt-2 p-3 block w-full bg-gray-900 border border-gray-700 rounded-md"
        />
      </div>
      <div className="mb-6">
